...
//         "01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48"].map(item => item.split(" ").map(items => parseInt(items)))
...
//                     numbers.push(grid[i][j + 1])
//                     numbers.push(grid[i][j + 2])
//                     numbers.push(grid[i][j + 3])
//                 }
//             }
//         }
//     }
...
//     let prob11div = document.querySelector(".problem11")!;
//     prob11div.innerHTML += "<h4>Largest Product in grid</h4>";
//     prob11div.innerHTML += "<p>" + maxProd + "</p>";
// }

// //problem12

// {
//     const generateTriangleNumbers = (n: number): number => {
//         if (n === 1) {
//             return n;
//         } else {
//             return ((n*(n+1)) / 2);
//         }
//     }
//     const getFactorLength = (n:number): number => {
//         let len = 0;
...
//     }
//     let i = 20;
//     while(getFactorLength(generateTriangleNumbers(i)) <= 500){
//         i++;
//     }
//     let answer = generateTriangleNumbers(12375);
//     let prob12div = document.querySelector(".problem12")!;
//     prob12div.innerHTML += "<h4>Highly divisible triangular number</h4>";
//     prob12div.innerHTML += "<p>" + answer + "</p>";
// }
...
//    ].map(item => parseInt(item)).reduce((prev, next) => prev+next)
//    console.log(numbers)
// }
...
// // problem 14
// {
//     let startingNum = 999999;
//     const nextCollatz = (x:number): number => {
//         if(x % 2 === 0){
//             return x / 2;
//         } else {
//             return ((3*x) + 1);
//         }
//     }
//     const generateCollatz = (x: number): number => {
//         let array: number[] = [];
//         array.push(x);
//         while(nextCollatz(x) !== 1){
//             x = nextCollatz(x);
//             array.push(x);
//         }
//         array.push(1)
...
//         if(generateCollatz(i) > maxArrLen){
//             maxArrLen = generateCollatz(i);
//             answer = i;
//         }
//     }
//     console.log(maxArrLen, answer)
//     // console.log(nextCollatz(2))
// }
